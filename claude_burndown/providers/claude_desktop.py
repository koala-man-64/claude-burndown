"""Claude quota from the desktop application's plan-usage history.

Reads plan-usage-history.json: `{"t": epoch ms, "org": id, "u": {"fh": five-hour %, "sd": seven-day %}}`.
Infers 5-hour and 7-day resets based on usage drops.
"""
